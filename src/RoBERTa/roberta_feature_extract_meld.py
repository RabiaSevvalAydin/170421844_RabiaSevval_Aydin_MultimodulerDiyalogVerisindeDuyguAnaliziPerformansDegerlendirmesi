...
speakers, emotion_labels, sentiment_labels, sentences, train_ids, test_ids, valid_ids = pickle.load(open('../../data/raw/meld.pkl', 'rb'))
...
pickle.dump([speakers, emotion_labels, sentiment_labels, roberta1, roberta2, roberta3, roberta4, sentences, train_ids, test_ids, valid_ids], open('../../data/models/models-roberta/meld_features_roberta.pkl', 'wb'))